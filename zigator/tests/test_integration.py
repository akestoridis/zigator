...
class TestIntegration(unittest.TestCase):
    ...
    def assertPrintConfig(self):
        ...
        with contextlib.redirect_stdout(tmp_stdout):
            with self.assertLogs(level="INFO") as cm:
                zigator.main(["zigator", "print-config"])
    ...
    def assertAddConfigEntry(self):
        ...
        self.assertTrue(
            "3c6047f3c55c8c8290a5839c213b6714\t"
            + "_derived_55555555555555555555555555555555a9d1"
            in link_keys,
        )
        install_codes = config_list[2].split("\n")
        self.assertGreater(len(install_codes), 0)
        ...
        expected_entries = [
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "23c864aa99d0d0ffff88776655443322"
                    + "11018e2c1c",
                ),
                ("mac_show", None),
                ("mac_fcs", "0x1c2c"),
                ...
                ("mac_assocreq_devtype", "0b1: Full-Function Device"),
                (
                    "mac_assocreq_powsrc",
                    "0b1: The sender is a mains-powered device",
                ),
                (
                    "mac_assocreq_rxidle",
                    "0b1: Does not disable the receiver to conserve power",
                ),
                (
                    "mac_assocreq_seccap",
                    "0b0: Cannot transmit and receive secure MAC frames",
                ),
                ("mac_assocreq_allocaddr", "0b1: Requests a short address"),
                ("der_tx_type", "Single-Hop Transmission"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "63cc72aa9988776655443322110dd0ee"
                ...
                ("mac_assocrsp_status", "0x00: Association successful"),
                ("der_tx_type", "Single-Hop Transmission"),
            ],
            [
                ("pcap_directory", None),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "03c820ffffffffffffeeffc0ced1ba0d"
                    + "d00608a2",
                ),
                ("mac_show", None),
                ("mac_fcs", "0xa208"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "03cc40ffffeeffc0ced1ba0dd0eeddce"
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "008089aa99addeff0f0000002294feca"
                ...
                ("nwk_beacon_protocolversion", "0b0010: Zigbee PRO"),
                (
                    "nwk_beacon_routercap",
                    "0b1: The sender can accept join requests from routers",
                ),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618844eedd000001f00910000001f001"
                ...
                ("nwk_protocolversion", "0b0010: Zigbee PRO"),
                ("nwk_discroute", "0b00: Suppress route discovery"),
                ("nwk_multicast", "0b0: NWK Multicast Disabled"),
                ("nwk_security", "0b0: NWK Security Disabled"),
                ("nwk_srcroute", "0b0: NWK Source Route Omitted"),
                ("nwk_extendeddst", "0b0: NWK Extended Destination Omitted"),
                ("nwk_extendedsrc", "0b1: NWK Extended Source Included"),
                ("nwk_edinitiator", "0b0: NWK Not End Device Initiator"),
                ...
                ("nwk_rejoinreq_devtype", "0b0: Zigbee End Device"),
                (
                    "nwk_rejoinreq_powsrc",
                    "0b0: The sender is not a mains-powered device",
                ),
                (
                    "nwk_rejoinreq_rxidle",
                    "0b0: Disables the receiver to conserve power when idle",
                ),
                (
                    "nwk_rejoinreq_seccap",
                    "0b0: Cannot transmit and receive secure MAC frames",
                ),
                ("nwk_rejoinreq_allocaddr", "0b1: Requests a short address"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "23c8daaa99d0d0ffff88776655443322"
                    + "1101596f",
                ),
                ("mac_show", None),
                ("mac_fcs", "0x6f59"),
            ...
            [
                ...
                ("nwk_aux_seclevel", "0b000: None"),
                ("nwk_aux_keytype", "0b01: Network Key"),
                ("nwk_aux_extnonce", "0b1: The source address is present"),
                ...
                (
                    "nwk_routerequest_ed",
                    "0b0: The extended destination address is not present",
                ),
                (
                    "nwk_routerequest_mc",
                    "0b0: The destination address is not a Group ID",
                ),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618866777701110211091a011102111d"
                ...
                ("nwk_security", "0b1: NWK Security Enabled"),
                ("nwk_srcroute", "0b0: NWK Source Route Omitted"),
                ("nwk_extendeddst", "0b1: NWK Extended Destination Included"),
                ("nwk_extendedsrc", "0b1: NWK Extended Source Included"),
                ("nwk_edinitiator", "0b0: NWK Not End Device Initiator"),
                ...
                (
                    "nwk_aux_decpayload",
                    ""
                    + "02300501110000080200000000777777"
                    + "0100000000777777",
                ),
                ("nwk_aux_decshow", None),
                ...
                (
                    "nwk_routereply_eo",
                    "0b1: The extended originator address is present",
                ),
                (
                    "nwk_routereply_er",
                    "0b1: The extended responder address is present",
                ),
                (
                    "nwk_routereply_mc",
                    "0b0: The responder address is not a Group ID",
                ),
                ("nwk_routereply_id", 5),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618867777701110211091a000002111e"
                ...
                ("nwk_networkstatus_code", "0x0c: Many-to-one route failure"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "4188687777ffff02110912fdff021101"
                ...
                (
                    "nwk_leave_rejoin",
                    "0b0: The device will not rejoin the network",
                ),
                (
                    "nwk_leave_request",
                    "0b0: The sending device wants to leave the network",
                ),
                (
                    "nwk_leave_rmch",
                    "0b0: "
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618869777700000211091a000001221e"
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "61886a77770211012209120211012201"
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "61886b777701220211091a0122021101"
                ...
                ("nwk_rejoinrsp_status", "0x00: Rejoin successful"),
                ("der_same_macnwkdst", "Same MAC/NWK Dst: True"),
                ("der_same_macnwksrc", "Same MAC/NWK Src: True"),
                ("der_tx_type", "Single-Hop Transmission"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "41886c7777ffff01110912fcff011101"
                ...
                (
                    "nwk_linkstatus_last",
                    "0b1: This is the last frame of the sender's link status",
                ),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "61886d7777000002110912000002111e"
                ...
                ("nwk_networkreport_type", "0b000: PAN Identifier Conflict"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "41886e7777ffff00000912ffff00001e"
                ...
                ("nwk_networkupdate_type", "0b000: PAN Identifier Update"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "61886f777702110222091a0211022201"
                ...
                ("nwk_edtimeoutreq_reqtime", "0x03: 8 minutes"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618870777702220211091a0222021101"
                ...
                ("nwk_cmd_payloadlength", 2),
                ("nwk_edtimeoutrsp_status", "0x00: Success"),
                (
                    "nwk_edtimeoutrsp_poll",
                    "0b1: MAC Data Poll Keepalive is supported",
                ),
                (
                    "nwk_edtimeoutrsp_timeout",
                    "0b1: End Device Timeout Request Keepalive is supported",
                ),
                ("der_same_macnwkdst", "Same MAC/NWK Dst: True"),
                ("der_same_macnwksrc", "Same MAC/NWK Src: True"),
                ("der_tx_type", "Single-Hop Transmission"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "4188717777ffff01110812fdff01111e"
                ...
                (
                    "nwk_aux_decpayload",
                    ""
                    + "08001300000000818101110200000000"
                    + "7777778e",
                ),
                ("nwk_aux_decshow", None),
                ("aps_frametype", "0b00: APS Data"),
                ("aps_delmode", "0b10: Broadcast"),
                ("aps_ackformat", "0b0: APS ACK Format Disabled"),
                ("aps_security", "0b0: APS Security Disabled"),
                ("aps_ackreq", "0b0: The sender does not request an APS ACK"),
                ("aps_exthdr", "0b0: The extended header is not included"),
                ("aps_dstendpoint", 0),
                ...
                ("zdp_deviceannce_devtype", "0b1: Full-Function Device"),
                (
                    "zdp_deviceannce_powsrc",
                    "0b1: The sender is a mains-powered device",
                ),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "6188729999000000b00910000000b001"
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "6188739999000000b00912000000b001"
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618800dddd000002110802000002111e"
                ...
                ("nwk_srcroute", "0b0: NWK Source Route Omitted"),
                ("nwk_extendeddst", "0b0: NWK Extended Destination Omitted"),
                ("nwk_extendedsrc", "0b0: NWK Extended Source Omitted"),
                ("nwk_edinitiator", "0b0: NWK Not End Device Initiator"),
                ("nwk_dstshortaddr", "0x0000"),
                ("nwk_srcshortaddr", "0x1102"),
                ("nwk_radius", 30),
                ...
                ("aps_delmode", "0b00: Normal unicast delivery"),
                ("aps_ackformat", "0b0: APS ACK Format Disabled"),
                ("aps_security", "0b0: APS Security Disabled"),
                ("aps_ackreq", "0b0: The sender does not request an APS ACK"),
                ("aps_exthdr", "0b0: The extended header is not included"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618801dddd021100000800021100001e"
                ...
                ("aps_exthdr", "0b0: The extended header is not included"),
                ("aps_counter", 100),
                ("aps_aux_seclevel", "0b000: None"),
                ("aps_aux_keytype", "0b10: Key-Transport Key"),
                ("aps_aux_extnonce", "0b1: The source address is present"),
                ...
                (
                    "aps_aux_decpayload",
                    ""
                    + "05011111111111111111111111111111"
                    + "11110003000000007777770100000000"
                    + "777777",
                ),
                ("aps_aux_decshow", None),
                ("aps_cmd_id", "0x05: APS Transport Key"),
                ("aps_transportkey_stdkeytype", "0x01: Standard Network Key"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618802dddd000002110802000002111e"
                ...
                (
                    "aps_updatedevice_status",
                    "0x01: Standard device unsecured rejoin",
                ),
                ("der_same_macnwkdst", "Same MAC/NWK Dst: True"),
                ("der_same_macnwksrc", "Same MAC/NWK Src: True"),
                ("der_tx_type", "Multi-Hop Transmission"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618803dddd021102220822000002221e"
                ...
                ("nwk_extendeddst", "0b0: NWK Extended Destination Omitted"),
                ("nwk_extendedsrc", "0b0: NWK Extended Source Omitted"),
                ("nwk_edinitiator", "0b1: NWK End Device Initiator"),
                ("nwk_dstshortaddr", "0x0000"),
                ("nwk_srcshortaddr", "0x2202"),
                ("nwk_radius", 30),
                ("nwk_seqnum", 243),
                ...
                (
                    "nwk_aux_decpayload",
                    ""
                    + "216620032800000500000000777777a1"
                    + "72bdcebf07",
                ),
                ("nwk_aux_decshow", None),
                ("aps_frametype", "0b01: APS Command"),
                ...
                ("aps_requestkey_reqkeytype", "0x04: Trust Center Link Key"),
                ("der_same_macnwkdst", "Same MAC/NWK Dst: False"),
                ("der_same_macnwksrc", "Same MAC/NWK Src: True"),
                ("der_tx_type", "Multi-Hop Transmission"),
                ("der_mac_dsttype", "MAC Dst Type: Zigbee Router"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618804dddd021100000802021100001e"
                ...
                (
                    "nwk_aux_decpayload",
                    ""
                    + "01670e05000000007777772168300528"
                ...
                ("aps_tunnel_frametype", "0b01: APS Command"),
                ("aps_tunnel_delmode", "0b00: Normal unicast delivery"),
                ("aps_tunnel_ackformat", "0b0: APS ACK Format Disabled"),
                ("aps_tunnel_security", "0b1: APS Security Enabled"),
                (
                    "aps_tunnel_ackreq",
                    "0b0: The sender does not request an APS ACK",
                ),
                (
                    "aps_tunnel_exthdr",
                    "0b0: The extended header is not included",
                ),
                ...
                ("aps_tunnel_cmd_id", "0x05: APS Transport Key"),
                ("aps_transportkey_stdkeytype", "0x01: Standard Network Key"),
                ("aps_transportkey_key", "11111111111111111111111111111111"),
                ("aps_transportkey_keyseqnum", 0),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618805dddd021100000806022200001e"
                ...
                ("nwk_multicast", "0b0: NWK Multicast Disabled"),
                ("nwk_security", "0b1: NWK Security Enabled"),
                ("nwk_srcroute", "0b1: NWK Source Route Included"),
                ("nwk_extendeddst", "0b0: NWK Extended Destination Omitted"),
                ("nwk_extendedsrc", "0b0: NWK Extended Source Omitted"),
                ("nwk_edinitiator", "0b0: NWK Not End Device Initiator"),
                ("nwk_dstshortaddr", "0x2202"),
                ...
                (
                    "nwk_aux_decpayload",
                    ""
                    + "21693807280000010000000077777799"
                ...
                ("aps_counter", 105),
                ("aps_aux_seclevel", "0b000: None"),
                ("aps_aux_keytype", "0b11: Key-Load Key"),
                ("aps_aux_extnonce", "0b1: The source address is present"),
                ...
                (
                    "aps_aux_decpayload",
                    ""
                    + "05047777777777777777777777777777"
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618806dddd021102220822000002221e"
                ...
                (
                    "nwk_aux_decpayload",
                    ""
                    + "416a0f04050000000077777744761a20"
                ...
                ("aps_ackformat", "0b0: APS ACK Format Disabled"),
                ("aps_security", "0b0: APS Security Disabled"),
                ("aps_ackreq", "0b1: The sender requests an APS ACK"),
                ("aps_exthdr", "0b0: The extended header is not included"),
                ("aps_counter", 106),
                ("aps_cmd_id", "0x0f: APS Verify Key"),
                ("aps_verifykey_stdkeytype", "0x04: Trust Center Link Key"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618807dddd021100000806022200001e"
                ...
                (
                    "nwk_aux_decpayload",
                    ""
                    + "616b200a2800000100000000777777f4"
                ...
                ("aps_confirmkey_status", "0x00: SUCCESS"),
                ("aps_confirmkey_stdkeytype", "0x04: Trust Center Link Key"),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618808ccbb023300000800023300001e"
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618809dddd021100000802021100001e"
                ...
                (
                    "nwk_aux_decpayload",
                    ""
                    + "016d0e0600000000777777216e300d28"
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "61880adddd021100000806042200001e"
                ...
                (
                    "nwk_aux_decpayload",
                    ""
                    + "616f200f2800000100000000777777ee"
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "418840ddddffff02110812fdff02111e"
                ...
                (
                    "nwk_aux_decpayload",
                    ""
                    + "08000000000000e98501000000007777"
                    + "770000",
                ),
                ("nwk_aux_decshow", None),
                ("aps_frametype", "0b00: APS Data"),
                ...
                ("aps_exthdr", "0b0: The extended header is not included"),
                ("aps_dstendpoint", 0),
                ("aps_cluster_id", "0x0000: NWK_addr_req"),
                ("aps_profile_id", "0x0000: Zigbee Device Profile (ZDP)"),
                ("aps_srcendpoint", 0),
                ("aps_counter", 233),
                ("zdp_seqnum", 133),
            ...
            [
                ...
                (
                    "phy_payload",
                    ""
                    + "618840dddd021100000802021100001e"
                ...
                ("aps_exthdr", "0b0: The extended header is not included"),
                ("aps_dstendpoint", 1),
                ("aps_cluster_id", "0x0000: Basic"),
                ("aps_profile_id", "0x0104: Zigbee Home Automation (ZHA)"),
                ("aps_srcendpoint", 1),
                ("aps_counter", 80),
                ("zcl_frametype", "0b00: Global Command"),
                (
                    "zcl_manufspecific",
                    "0b0: The command is not manufacturer-specific",
                ),
                ("zcl_direction", "0b0: From the client to the server"),
                ("zcl_disdefrsp", "0b0: A Default Response will be returned"),
                ("zcl_seqnum", 0),
                ("zcl_cmd_id", "0x00: Read Attributes"),
    ...
    def assertEntries(self, obtained_entries, expected_entries):
        self.assertEqual(len(obtained_entries), len(expected_entries))
        for i in range(len(expected_entries)):
            self.assertEqual(
                len(obtained_entries[i]),
                len(expected_entries[i]),
            )
            for j in range(len(expected_entries[i])):
                self.assertEqual(
                    obtained_entries[i][j][0],
                    expected_entries[i][j][0],
                )
    ...
    def assertAnyRegex(self, obtained_strings, expected_pattern):
        self.assertTrue(
            any(
                re.search(expected_pattern, obtained_string) is not None
                for obtained_string in obtained_strings
            ),
        )
